...
class PlantillaDocumentoController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('plantilla-documento.index', compact('documentos'));
    }
    ...
    public function store(Request $request)
    {
      ...
      if(Auth::user()->empresa->documentos()->save($documento)){
        return redirect()->route('plantilla.documento.show', ['documento' => $documento->id])->with([
    ...
    public function edit(Documento $documento)
    {
      ...
      return view('plantilla-documento.edit', compact('documento', 'contratos', 'plantillas', 'padres'));
    }
    ...
    {
      if($documento->delete()){
        return redirect()->route('plantilla.documento.index')->with([
