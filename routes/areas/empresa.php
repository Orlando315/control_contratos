...
Route::group(['middleware' => 'role:developer|superadmin|empresa|administrador'], function(){
  /* --- Usuarios --- */
...
Route::group(['middleware' => 'role:developer|superadmin|empresa|administrador|supervisor'], function(){
  /* --- Contratos --- */
