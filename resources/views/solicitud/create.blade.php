        ...
        <div class="ibox-content">
          <form action="{{ route('solicitud.store') }}" method="POST">
              ...
              <div class="col-md-4">
                <div class="form-group{{ $errors->has('tipo') ? ' has-error' : '' }}">
                  ...
                  <select id="tipo" class="form-control" name="tipo" required>
                    ...
                    <option value="certificado"{{ old('tipo') == 'certificado' ? ' selected' : '' }}>Certificado laboral</option>
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('solicitud.index') }}"><i class="fa fa-reply"></i> Atras</a>
