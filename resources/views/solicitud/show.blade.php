...
@section('content')
  <div class="row mb-3">
    <div class="col-12">
      <a class="btn btn-default btn-sm" href="{{ route('solicitud.index') }}"><i class="fa fa-reply" aria-hidden="true"></i> Volver</a>
      @if($solicitud->isPendiente())
        <a class="btn btn-default btn-sm" href="{{ route('solicitud.edit', ['solicitud' => $solicitud->id]) }}"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
      @endif
  ...
  <div id="delModal" class="modal inmodal fade" tabindex="-1" role="dialog" aria-labelledby="delModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="{{ route('solicitud.destroy', ['solicitud' => $solicitud->id]) }}" method="POST">
          @method('DELETE')
          @csrf
