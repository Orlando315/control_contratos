...
@section('content')
  <div class="row mb-3">
    <div class="col-12">
      ...
      @if(Auth::user()->tipo == 1)
        <a class="btn btn-default btn-sm" href="{{ route('empresas.edit') }}"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
      @else
        <a class="btn btn-default btn-sm" href="{{ route('usuarios.editPerfil') }}"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
      @endif
