    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('usuarios.updatePerfil') }}" method="POST">
            {{ method_field('PATCH') }}
            {{ csrf_field() }}
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                  ...
                  <input id="email" class="form-control" type="email" name="email" maxlength="50" value="{{ old('email', Auth::user()->email) }}" placeholder="Email">
                </div>
              </div>
              <div class="col-md-6">
