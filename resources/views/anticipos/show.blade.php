...
@section('content')
  <div class="row mb-3">
    <div class="col-12">
      <a class="btn btn-default btn-sm" href="{{ route('anticipos.index') }}"><i class="fa fa-reply" aria-hidden="true"></i> Volver</a>
      <a class="btn btn-default btn-sm" href="{{ route('anticipos.edit', ['anticipo' => $anticipo->id]) }}"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
        ...
        <div class="ibox-content no-padding">
          <ul class="list-group">
            ...
            <li class="list-group-item">
              <b>Empleado</b>
              <span class="pull-right">
                <a href="{{ route('empleados.show', ['empleado' => $anticipo->empleado_id]) }}">
  ...
  <div id="delModal" class="modal inmodal fade" tabindex="-1" role="dialog" aria-labelledby="delModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="{{ route('anticipos.destroy', ['anticipo' => $anticipo->id]) }}" method="POST">
          {{ method_field('DELETE') }}
          {{ csrf_field() }}
