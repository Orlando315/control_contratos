    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('inventarios.update', ['id' => $inventario->id]) }}" method="POST" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            {{ csrf_field() }}
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('inventarios.show', ['inventario' => $inventario->id] ) }}"><i class="fa fa-reply"></i> Atras</a>
