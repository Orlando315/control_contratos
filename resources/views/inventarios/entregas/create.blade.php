  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('inventarios.show', ['inventario' => $inventario->id]) }}">Inventarios</a></li>
    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('entregas.store', ['inventario' => $inventario->id]) }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
