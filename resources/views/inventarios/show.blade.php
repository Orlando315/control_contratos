        ...
        <div class="ibox-title">
          ...
          @if($inventario->documentos->count() < 10)
            <div class="ibox-tools">
              <a class="btn btn-warning btn-xs" href="{{ route('carpeta.create', ['type' => 'inventarios', 'id' => $inventario->id]) }}"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Carpeta</a>
              <a class="btn btn-primary btn-xs" href="{{ route('documentos.create', ['type' => 'inventarios', 'id' => $inventario->id]) }}"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Adjunto</a>
            </div>
          @endif
        </div>
