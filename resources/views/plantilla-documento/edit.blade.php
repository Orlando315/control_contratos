    ...
    <div class="col-md-8">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('plantilla.documento.update', ['documento' => $documento->id]) }}" method="POST">
            {{ method_field('PUT') }}
            {{ csrf_field() }}
            ...
            <div class="text-right mt-2">
              <a class="btn btn-default btn-sm" href="{{ route('plantilla.documento.show', ['documento' => $documento->id] ) }}"><i class="fa fa-reply"></i> Atras</a>
