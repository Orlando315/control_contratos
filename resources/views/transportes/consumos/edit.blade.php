    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form  action="{{ route('consumos.update', ['consumo' => $consumo->id]) }}" method="POST" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            {{ csrf_field() }}
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('consumos.show', ['consumo' => $consumo->id] ) }}"><i class="fa fa-reply"></i> Atras</a>
