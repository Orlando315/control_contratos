    ...
    <div class="col-md-10">
      <div class="ibox">
        ...
        <div class="ibox-content">
          ...
          <form action="{{ route('requerimiento.material.update', ['requerimiento' => $requerimiento->id]) }}" method="POST">
            @method('PATCH')
            @csrf
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('requerimiento.material.show', ['requerimiento' => $requerimiento->id]) }}"><i class="fa fa-reply"></i> Atras</a>
