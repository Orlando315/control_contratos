  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('contratos.show', ['contrato' => $empleado->contrato_id]) }}">Empleados</a></li>
        ...
        <div class="ibox-content">
          <form action="{{ route('empleados.update', ['empleado' => $empleado->id]) }}" method="POST">
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('empleados.show', ['empleado' => $empleado->id] ) }}"><i class="fa fa-reply"></i> Atras</a>
