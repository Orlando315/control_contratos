    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('admin.direccion.store', ['id' => $model->id, 'type' => $type]) }}" method="POST">
            @csrf
            ...
            <div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }}">
              ...
              <input id="direccion" class="form-control" type="text" name="direccion" maxlength="200" value="{{ old('direccion') }}" placeholder="Dirección" required>
            </div>
