  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.development.variable.index') }}">Variables</a></li>
    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('admin.development.variable.update', ['variable' => $variable->id]) }}" method="POST">
            @csrf
            @method('PUT')
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('tipo') ? ' has-error' : '' }}">
                  ...
                  <select id="tipo" class="form-control" name="tipo" required>
                    <option value="empleado"{{ old('tipo', $variable->tipo) == 'empleado' ? ' selected' : '' }}>Empleado</option>
                    <option value="postulante"{{ old('tipo', $variable->tipo) == 'postulante' ? ' selected' : '' }}>Postulante</option>
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('admin.development.variable.index') }}"><i class="fa fa-reply"></i> Atras</a>
