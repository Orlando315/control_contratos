    ...
    <div class="col-md-6">
      <div class="ibox">
        <div class="ibox-title">
          <h5>Agregar variable global</h5>
        </div>
        <div class="ibox-content">
          <form action="{{ route('admin.development.variable.store') }}" method="POST">
            @csrf
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('tipo') ? ' has-error' : '' }}">
                  ...
                  <select id="tipo" class="form-control" name="tipo" required>
                    ...
                    <option value="postulante"{{ old('tipo') == 'postulante' ? ' selected' : '' }}>Postulante</option>
