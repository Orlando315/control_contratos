...
@section('content')
  <div class="row mb-3">
    <div class="col-12">
      <a class="btn btn-default btn-sm" href="{{ route('admin.development.role.index') }}"><i class="fa fa-reply" aria-hidden="true"></i> Volver</a>
      <a class="btn btn-default btn-sm" href="{{ route('admin.development.role.edit', ['role' => $role->id]) }}"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
        ...
        <div class="ibox-content py-2">
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item px-0">
              ...
              <p class="m-0">@nullablestring($role->display_name)</p>
            </li>
            <li class="list-group-item px-0">
              <strong>Description</strong>
              <p class="m-0">@nullablestring($role->description)</p>
            </li>
          </ul>
        </div>
    ...
    <div class="col-md-9">
      <div class="tabs-container">
        <ul class="nav nav-tabs">
          <li><a class="nav-link active" href="#tab-1" data-toggle="tab"><i class="fa fa-key" aria-hidden="true"></i> Permissions</a></li>
                ...
                <tbody>
                  @foreach($role->permissions as $permission)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin.development.permission.show', ['permission' => $permission->id]) }}">
                          {{ $permission->name }}
                        </a>
                      </td>
                      <td>@nullablestring($permission->display_name)</td>
  ...
  <div id="delModal" class="modal inmodal fade" tabindex="-1" role="dialog" aria-labelledby="delModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="{{ route('admin.development.role.destroy', ['role' => $role->id]) }}" method="POST">
          @method('DELETE')
          @csrf
          ...
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="delModalLabel">Eliminar Role</h4>
          </div>
          <div class="modal-body">
            <h4 class="text-center">¿Esta seguro de eliminar este Role?</h4>
