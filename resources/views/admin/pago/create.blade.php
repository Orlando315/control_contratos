  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.facturacion.show', ['facturacion' => $facturacion->id]) }}">Facturación</a></li>
    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('admin.pago.store', ['facturacion' => $facturacion->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf

            <h4 class="text-center">Total por pagar: {{ $facturacion->pendiente() }}</h4>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('monto') ? ' has-error' : '' }}">
                  ...
                  <select id="metodo" class="custom-select" name="metodo" required>
                    ...
                    <option value="deposito"{{ old('metodo') == 'deposito' ? ' selected' : '' }}>Deposito</option>
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('otro') ? ' has-error' : '' }}" style="display: none">
                  ...
                  <input id="otro" class="form-control" type="text" name="otro" maxlength="20" value="{{ old('otro') }}" placeholder="Otro método" required disabled>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('monto') ? ' has-error' : '' }}">
                  ...
                  <input id="monto" class="form-control" type="number" name="monto" min="0" max="{{ $facturacion->pendiente }}" step="0.01" value="{{ old('monto') }}" placeholder="Monto" required>
                  <small class="form-text text-muted">Monto máximo: {{ $facturacion->pendiente() }}</small>
                </div>
              </div>
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('admin.facturacion.show', ['facturacion' => $facturacion->id]) }}"><i class="fa fa-reply"></i> Atras</a>
