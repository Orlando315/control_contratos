    ...
    <div class="col-md-6">
      @if(Auth::user()->empresa->configuracion->isIntegrationIncomplete('sii'))
        <div class="alert alert-danger alert-important">
          <p class="m-0"><strong>¡Integración incompleta!</strong> Debe completar los datos de su integración con Facturación Sii antes de poder agregar un cliente Empresa. <a href="{{ route('perfil.edit') }}">Editar perfil Empresa</a></p>
        </div>
      @endif
