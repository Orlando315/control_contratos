...
@section('content')
  <div class="row justify-content-center mb-3 no-print">
    ...
    <div class="col-md-4 no-print">
      <form id="exportForm" action="{{ route('admin.reportes.facturas.get') }}" method="POST">
        {{ csrf_field() }}
    ...
    function getEvents(e){
      ...
      .done(function(facturas){
        ...
        $.each(facturas, function(i, factura){
          ...
          tr += `<td class="text-center">${factura.valor.toLocaleString('de-DE')}</td>`
        ...
        $('#total-ingresos').text(totalIngresos.toLocaleString('de-DE'))
        $('#total-egresos').text(totalEgresos.toLocaleString('de-DE'))
        $('#total-facturas').text(totalFacturas.toLocaleString('de-DE'))
      })
      .fail(function(){
