  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.contrato.show', ['contrato' => $requisito->contrato_id]) }}">Contrato</a></li>
        ...
        <div class="ibox-content">
          <form action="{{ route('admin.requisito.update', ['requisito' => $requisito->id]) }}" method="POST">
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('admin.contrato.show', ['contrato' => $requisito->contrato_id]) }}"><i class="fa fa-reply"></i> Atras</a>
