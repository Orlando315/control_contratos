        ...
        <div class="tab-content">
          <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
              <div class="mb-3">
                <a class="btn btn-primary btn-sm" href="{{ route('admin.plantilla.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Plantilla</a>
              </div>
                ...
                <tbody class="text-center">
                  @foreach($plantillas as $d)
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-success btn-xs" href="{{ route('admin.plantilla.show', ['plantilla' => $d->id] )}}"><i class="fa fa-search"></i></a>
                        <a class="btn btn-primary btn-xs" href="{{ route('admin.plantilla.edit', ['plantilla' => $d->id] )}}"><i class="fa fa-pencil"></i></a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
    ...
    $(document).ready(function(){
      $('#delModal').on('show.bs.modal', function(e){
        var btn = $(e.relatedTarget),
            ...
            action = '{{ route("admin.variable.index") }}/' + variable;
