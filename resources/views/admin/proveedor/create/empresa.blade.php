    ...
    <div class="col-md-6">
      ...
      <div class="ibox">
        <div class="ibox-title">
          <h5>Agregar proveedor - Empresa</h5>
        </div>
        <div class="ibox-content">
          ...
          <form action="{{ route('admin.proveedor.store', ['type' => 'empresa']) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-checkbox">
                <input id="cliente" class="custom-control-input" type="checkbox" name="cliente" value="1"{{ old('cliente') == '1' ? ' checked' : '' }}>
