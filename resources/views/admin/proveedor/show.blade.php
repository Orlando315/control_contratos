      ...
      <div class="ibox">
        <div class="ibox-content no-padding">
          <ul class="list-group list-group-unbordered">
            ...
            <li class="list-group-item">
              <b>RUT</b>
              <span class="pull-right">{{ $proveedor->rut ?? 'N/A' }}</span>
            </li>
            @if($proveedor->isPersona())
              <li class="list-group-item">
                <b>Teléfono</b>
                <span class="pull-right">{{ $proveedor->telefono ?? 'N/A' }}</span>
              </li>
              <li class="list-group-item">
                <b>Email</b>
                <span class="pull-right">{{ $proveedor->email ?? 'N/A' }}</span>
              </li>
              <li class="list-group-item">
                <b>Descripción</b>
                <span class="pull-right">{{ $proveedor->descripcion ?? 'N/A' }}</span>
              </li>
            @endif
            <li class="list-group-item">
              <b>Tipo</b>
