  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.bodega.show', ['bodega' => $bodega->id]) }}">Ubicaciones</a></li>
    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('admin.ubicacion.store', ['bodega' => $bodega->id]) }}" method="POST">
            @csrf
