    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('admin.manage.unidad.store') }}" method="POST">
            @csrf
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('admin.manage.unidad.index') }}"><i class="fa fa-reply"></i> Atras</a>
