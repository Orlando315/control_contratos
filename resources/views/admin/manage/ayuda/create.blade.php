    ...
    <div class="col-md-10">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('admin.manage.ayuda.store') }}" method="POST">
            @csrf

            <div class="form-group{{ $errors->has('titulo') ? ' has-error' : '' }}">
              <label for="titulo">Título: *</label>
              <input id="titulo" class="form-control" type="text" name="titulo" maxlength="250" value="{{ old('titulo') }}" placeholder="Título" required>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('video') ? ' has-error' : '' }}">
                  ...
                  <input id="video" class="form-control" type="text" name="video" minlength="11" maxlength="11" value="{{ old('video') }}" placeholder="Video ID">
                ...
                @foreach($roles as $role)
                  <div class="col-md-4">
                    <div class="custom-control custom-checkbox">
                      <input id="role-{{ $role->id }}" class="custom-control-input" type="checkbox" name="roles[]" value="{{ $role->id }}"{{ in_array($role->id, old('roles', [])) ? ' checked' : '' }}>
            ...
            <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
              ...
              <div class="custom-control custom-switch">
                <input id="status" class="custom-control-input" type="checkbox" name="status" value="1"{{ old('status', '1') ? ' checked' : '' }}>
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('admin.manage.ayuda.index') }}"><i class="fa fa-reply"></i> Atras</a>
