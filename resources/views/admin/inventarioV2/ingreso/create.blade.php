  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.inventario.v2.show', ['inventario' =>  $inventario->id]) }}">Ingreso de Stock</a></li>
    ...
    <div class="col-md-10">
      <div class="ibox">
        <div class="ibox-title">
          <h4>Agregar Ingreso de Stock</h4>
        </div>
        <div class="ibox-content">
          <form action="{{ route('admin.inventario.ingreso.store', ['inventario' => $inventario->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf()
