    ...
    <div class="col-md-10">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('admin.inventario.store') }}" method="POST" enctype="multipart/form-data">
            @csrf()
                  ...
                  <div class="form-group{{ $errors->has('contrato_id') ? ' has-error' : '' }}">
                    ...
                    <select id="contrato_id" class="form-control" name="contrato_id" required>
                      ...
                      @foreach($contratos as $contrato)
                        <option value="{{ $contrato->id }}"{{ old('contrato_id', ($contrato->isMain() ? $contrato->id : '')) == $contrato->id ? ' selected' : '' }}>{{ $contrato->nombre }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="custom-control custom-checkbox">
                    <input id="calibracion" class="custom-control-input" type="checkbox" name="calibracion" value="1">
                    <label class="custom-control-label" for="calibracion">Requiere calibración</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="custom-control custom-checkbox">
                    <input id="certificado" class="custom-control-input" type="checkbox" name="certificado" value="1">
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('admin.inventario.index') }}"><i class="fa fa-reply"></i> Atras</a>
