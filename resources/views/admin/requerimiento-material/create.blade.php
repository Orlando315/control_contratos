    ...
    <div class="col-md-10">
      <div class="ibox">
        ...
        <div class="ibox-content">
          ...
          <form action="{{ route('admin.requerimiento.material.store') }}" method="POST">
            @csrf
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('admin.requerimiento.material.index') }}"><i class="fa fa-reply"></i> Atras</a>
