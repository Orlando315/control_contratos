            ...
            <tbody class="text-center">
              @foreach($anticipos as $d)
                <tr>
                  ...
                  <td><a href="{{ route('admin.empleados.show', ['empleado' => $d->empleado->id]) }}">{{ $d->empleado->usuario->nombres }} {{ $d->empleado->usuario->apellidos }}</a></td>
                  <td>{{ $d->fecha }}</td>
                  <td>{{ $d->anticipo() }}</td>
                  ...
                  <td>
                    ...
                    <a class="btn btn-primary btn-xs" href="{{ route('admin.anticipos.edit', ['anticipo' => $d->id] )}}"><i class="fa fa-pencil"></i></a>
                  </td>
                </tr>
              @endforeach
            </tbody>
