...
@section('content')
  <div class="row mb-3">
    <div class="col-12">
      <a class="btn btn-default btn-sm" href="{{ route('gastos.index') }}"><i class="fa fa-reply" aria-hidden="true"></i> Volver</a>
      <a class="btn btn-default btn-sm" href="{{ route('gastos.edit', ['gasto' => $gasto->id]) }}"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
        ...
        <div class="ibox-content no-padding">
          <ul class="list-group">
            ...
            <li class="list-group-item">
              ...
              <span class="pull-right">
                @if(Auth::user()->tipo <= 2)
                  <a href="{{ route('etiquetas.show', ['etiqueta' => $gasto->etiqueta_id]) }}">{{ $gasto->etiqueta->etiqueta }}</a>
                @else
  ...
  <div id="delModal" class="modal inmodal fade" tabindex="-1" role="dialog" aria-labelledby="delModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="{{ route('gastos.destroy', ['gasto' => $gasto->id]) }}" method="POST">
          {{ method_field('DELETE') }}
          {{ csrf_field() }}
