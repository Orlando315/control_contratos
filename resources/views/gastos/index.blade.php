      ...
      <div class="ibox">
        <div class="ibox-title">
          ...
          <div class="ibox-tools">
            <a class="btn btn-primary btn-xs" href="{{ route('gastos.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Gasto</a>
          </div>
        </div>
        <div class="ibox-content">
            ...
            <tbody class="text-center">
              @foreach($gastos as $d)
                <tr>
                  ...
                  <td><a href="{{ route('contratos.show', ['contrato', $d->contrato_id]) }}">{{ $d->contrato->nombre }}</a></td>
                  <td><a href="{{ route('etiquetas.show', ['etiqueta', $d->etiqueta_id]) }}">{{ $d->etiqueta->etiqueta }}</a></td>
                  <td>{{ $d->nombre }}</td>
                  <td>{{ $d->valor() }}</td>
                  <td>
