    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('carpeta.update', ['carpeta' => $carpeta->id]) }}" method="POST">
            {{ method_field('PATCH') }}
            {{ csrf_field() }}
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('carpeta.show', ['carpeta' => $carpeta->id]) }}"><i class="fa fa-reply"></i> Atras</a>
