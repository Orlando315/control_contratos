    ...
    <div class="col-md-6">
      <div class="ibox">
        ...
        <div class="ibox-content">
          <form action="{{ route('contratos.update', ['id' => $contrato->id]) }}" method="POST">
            {{ method_field('PATCH') }}
            {{ csrf_field() }}
            ...
            <div class="text-right">
              <a class="btn btn-default btn-sm" href="{{ route('contratos.show', [$contrato->id] ) }}"><i class="fa fa-reply"></i> Atras</a>
