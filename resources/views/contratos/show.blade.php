      ...
      <div class="tabs-container">
        ...
        <div class="tab-content">
            ...
            <div class="panel-body">
              <div class="mb-3">
                ...
                @if($contrato->documentos->count() < 10)
                  <a class="btn btn-primary btn-sm" href="{{ route('documentos.create', ['type' => 'contratos', 'id' => $contrato->id]) }}"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Adjunto</a>
                @endif
              </div>
          ...
          <div class="tab-pane" id="tab-12">
            <div class="panel-body">
              <div class="mb-3">
                <a class="btn btn-primary btn-sm" href="{{ route('plantilla.documento.create', ['contrato' => $contrato->id]) }}"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Documento</a>
              </div>
      ...
      <div class="tabs-container">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-21">
            <div class="panel-body">
              <div class="mb-3">
                <a class="btn btn-default btn-sm" href="{{ route('sueldos.index', ['contrato' => $contrato->id]) }}"><i class="fa fa-money" aria-hidden="true"></i> Ver sueldos</a>
                <a class="btn btn-default btn-sm" href="{{ route('contratos.calendar', ['contrato' => $contrato->id]) }}"><i class="fa fa-calendar" aria-hidden="true"></i> Ver calendario</a>
                <a class="btn btn-primary btn-sm" href="{{ route('empleados.create', ['contrato' => $contrato->id]) }}"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo empleado</a>
              </div>
              <table class="table data-table table-bordered table-hover table-sm w-100">
                <thead>
                  <tr>
                ...
                <tbody class="text-center">
                  @foreach($contrato->empleados as $d)
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-success btn-xs" href="{{ route('empleados.show', ['empleado' => $d->id]) }}"><i class="fa fa-search"></i></a>
                        <a class="btn btn-primary btn-xs" href="{{ route('empleados.edit', ['empleado' => $d->id]) }}"><i class="fa fa-pencil"></i></a>
                      </td>
                    </tr>
                  @endforeach
                </tbody>
