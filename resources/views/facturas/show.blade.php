...
@section('content')
  <div class="row mb-3">
    <div class="col-12">
      <a class="btn btn-default btn-sm" href="{{ route('facturas.index') }}"><i class="fa fa-reply" aria-hidden="true"></i> Volver</a>
      <a class="btn btn-default btn-sm" href="{{ route('facturas.edit', ['factura' => $factura->id]) }}"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
          ...
          <ul class="list-group">
            <li class="list-group-item">
              ...
              <span class="pull-right">
                <a href="{{ route('contratos.show', ['contrato' => $factura->contrato->id]) }}">
            ...
            @if($factura->etiqueta)
              <li class="list-group-item">
                ...
                <span class="pull-right">
                  @if(Auth::user()->tipo <= 2)
                    <a href="{{ route('etiquetas.show', ['etiqueta' => $factura->etiqueta_id]) }}">
      ...
      <div class="modal-content">
        <form action="{{ route('facturas.destroy', [$factura->id]) }}" method="POST">
          ...
          <div class="modal-body">
            <h4 class="text-center">¿Esta seguro de eliminar este Factura?</h4>
          </div>
